...
export const adminOrders = [
  { code: "KBY-1008", user: "Ayse Demir", amount: "2.820 TL", status: "PAID", date: "2026-04-29" },
  { code: "KBY-1007", user: "Mert Kaya", amount: "950 TL", status: "PENDING", date: "2026-04-28" },
  { code: "KBY-1006", user: "Elif Sahin", amount: "420 TL", status: "CANCELLED", date: "2026-04-27" }
];
